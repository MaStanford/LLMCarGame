...
def generate_factions_from_llm():
    """
    Generates a new set of factions by calling a local LLM.
    """
    ...
    # faction_json_str = response["choices"][0]["text"]
    ...
    faction_json_str = """
{
  ...
  "the_junction": {
    ...
    # --- 3. Parse and Return ---
    try:
        faction_data = json.loads(faction_json_str)
        # TODO: Add validation against a schema
        return faction_data
    except (json.JSONDecodeError, KeyError) as e:
        print(f"Error parsing LLM output for factions: {e}")
